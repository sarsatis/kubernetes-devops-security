...
docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t $APPLICATION_URL:$PORT/v3/api-docs -f openapi -c zap_rules -r zap_report.html
